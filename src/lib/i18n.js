  ...
  en: {
    translation: {
      ...
      admin: {
        ...
        bookings: { showing: "Showing", of: "of", search: "Search name, email, service…", empty: "No bookings match your search.", cols: { devotee: "Devotee", phone: "Phone", service: "Service", amount: "Amount", date: "Date", status: "Status" }, actions: { confirm: "Confirm", cancel: "Cancel", delete: "Delete" }, totalRevenue: "Total revenue", totalCost: "Total bookings cost", confirmedNote: "{{count}} confirmed", allNote: "{{count}} total" },
  ...
  hi: {
    translation: {
      ...
      admin: {
        ...
        bookings: { showing: "दिखाई जा रही", of: "में से", search: "नाम, ईमेल, सेवा खोजें…", empty: "कोई बुकिंग नहीं मिली।", cols: { devotee: "भक्त", phone: "फ़ोन", service: "सेवा", amount: "राशि", date: "तिथि", status: "स्थिति" }, actions: { confirm: "पुष्टि", cancel: "रद्द", delete: "हटाएँ" }, totalRevenue: "कुल राजस्व", totalCost: "कुल बुकिंग लागत", confirmedNote: "{{count}} पुष्ट", allNote: "{{count}} कुल" },
  ...
  mr: {
    translation: {
      ...
      admin: {
        ...
        bookings: { showing: "दर्शवित आहे", of: "पैकी", search: "नाव, ईमेल, सेवा…", empty: "बुकिंग सापडली नाही.", cols: { devotee: "भक्त", phone: "फोन", service: "सेवा", amount: "रक्कम", date: "तारीख", status: "स्थिती" }, actions: { confirm: "पुष्टी", cancel: "रद्द", delete: "हटवा" }, totalRevenue: "एकूण महसूल", totalCost: "एकूण बुकिंग खर्च", confirmedNote: "{{count}} पुष्ट", allNote: "{{count}} एकूण" },
